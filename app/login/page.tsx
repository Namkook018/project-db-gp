      ...
      <div className="animate-fadeInUp" style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}>
            <Image src="/logo.png" alt="CPR Logo" width={80} height={80} style={{ objectFit: 'contain', background: '#fff', borderRadius: '50%', padding: 4, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
          </div>
